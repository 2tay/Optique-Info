    ...
    <div>
      ...
      <div class="container mt-4">
        ...
        <div class="row mt-4">
          ...
          <div v-for="fullName in FullNames" :key="fullName.id" class="col-md-3 mb-4">
            <div class="border p-4 h-100 text-center custom-card"> <!-- Adding a custom class for the other cards -->
              ...
              <router-link :to="{ name: 'clientdetail', params: { id: fullName.id } }" class="btn btn-primary btn-lg text-white text-decoration-none">Check</router-link>
            </div>
          </div>
        </div>
      </div>
